#prevede cislo v intervalu 0 az 100 na jeho textovou podobu
    ...
    if cislo_cislem < 0:
        ...
        if cislo_cislem < 100:
            ...
            if (cislo_cislem >= 10 and cislo_cislem < 20):
                ...
                cislo_slovy = nactky[int(cislo[1])]
            else:
                ...
                if cislo_cislem < 10:
                    cislo_slovy = jednotky[int(cislo[0])]
                else:
                    if (cislo_cislem%10)!=0:
                        cislo_slovy = desitky[int(cislo[0])-2] +" "+jednotky[int(cislo[1])]
                    else:
                        cislo_slovy = desitky[int(cislo[0])-2]
